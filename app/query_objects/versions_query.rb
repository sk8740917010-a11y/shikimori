class VersionsQuery < QueryObjectBase
  ...
  def state_condition(field)
    ...
    screenshots_sql = ApplicationRecord.sanitize(Versions::ScreenshotsVersion::Actions[:upload])
    videos_sql = ApplicationRecord.sanitize(Versions::VideoVersion::Actions[:upload])
